...
function AppHeader() {
    return (
        <header className={stylesHeader.header}>
            <nav className={`${stylesHeader.header__navigation} pb-4 pt-4`}>
                <ul className={stylesHeader.header__list}>
                    <div className={stylesHeader.header__list_wrapper}>
                        <li className={stylesHeader.header__item}>
                            <a className={stylesHeader.header__link} href='#'>
                    ...
                    <div className={stylesHeader.header__list_wrapper}>
                        <li className={`${stylesHeader.header__item} pr-5`}>
                            <a className={stylesHeader.header__link} href='#'>
